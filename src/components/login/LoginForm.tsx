...
import Input from '../inputs/LableTopInput'
		...
		<div className='wrapper mt-[0px] min-h-screen flex items-center justify-center'>
			<div className='bg-white border-2 rounded-lg p-4 text-center'>
				...
				<form onSubmit={handleSubmit(onSubmit)} className='grid gap-4'>
					...
					<button
						type='submit'
						className='bg-blue-500 text-white hover:text-black py-2 px-4 rounded-md hover:bg-yellow-400 transition duration-300'
					>
						Войти
					</button>
				</form>
